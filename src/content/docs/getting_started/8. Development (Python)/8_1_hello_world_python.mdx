...
Somewhere on your hard drive create an empty directory and create a file `hello_world.py` with the following content:

<Code code={sndHelloWorldPY} lang="python" title="hello_world.py"/>

...
import ecalMulticastLoopback from '../../../assets/netplan/50-ecal-multicast-loopback.yaml';
...
2. [Test the Configuration](https://eclipse-ecal.github.io/ecal/getting_started/cloud.html#ubuntu-multicast-route-test)
</Steps>
  ...
  <TabItem label="Netplan (recommended)">
   ...
   .. tab:: Netplan (recommended)
      ...
      1. Configure the **loopback multicast** route (this will become active, if you disconnect from all networks).
        ...
        <CodeBlock language="yaml">{ecalMulticastLoopback}</CodeBlock>

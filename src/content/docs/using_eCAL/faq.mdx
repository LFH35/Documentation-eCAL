...
Try to [configure eCAL in local mode](/using_ecal/configuration/local_configuration/) or disconnect from the VPN.
...
[Increase the limit](/using_ecal/configuration/ubuntu_player_max_open_files/) and the Player should work just fine, again!
...
2. Check the `hosts` file on all PCs and try to ping them **by name**! You can follow the [getting started tutorial](/getting_started/5_ecal_services/)!
...
![Ubuntu 22.04 on Xorg](../../../assets/ubuntu_22_04_on_xorg_cut.svg)
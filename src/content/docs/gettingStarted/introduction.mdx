...
description: A Introduction in eCAL.
---
...
If you have ever worked with other publish subscribe middlewares like [MQTT](https://en.wikipedia.org/wiki/MQTT) or [ROS](https://www.ros.org/), you should be familiar with the terminology.
...
![eCAL concept](../../../assets/ecal_concept_notebooks.svg)
...
<Aside>eCAL works entirely decentral. It does not rely on a central broker, like the *MQTT Broker* or the *roscore* from ROS1</Aside>
